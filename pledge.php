...
<!--                    <ul id="navlist"><li class="active"><a href="#">this is a test</a></li></ul>
            ...
            <div  class="grid_48">        
                <div id="content" class="grid_44 push_2"><!--actual content-->
                	...
                	<div id="main-left" class="grid_20 push_1 alpha"><!--Left main content -->
                        <h2>"From now on, I pledge to conserve paper,water, and electricity in order save both money and the planet."</h2>     
                    </div><!--end left main content -->
                    <div id="main-right" class="grid_20 push_4 omega">
                ...
                <div  class="grid_44 "><!--actual content-->

            		<div class="grid_22 prefix_2 alpha">
                    ...
                    <div id="fb" class="grid_20 push_2 omega">
                    <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like-box href="http://www.facebook.com/pages/Greenserve/158651644197000" width="400" show_faces="true" stream="false" header="true"></fb:like-box>
                    </div>                    <style>.connect_widget {background:#FFF;}.phs {background:#FFF;}.pts {background:#FFF;}#fb{background:#FFF;}</style>
